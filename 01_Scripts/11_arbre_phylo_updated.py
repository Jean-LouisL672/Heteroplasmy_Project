#!/usr/bin/env python3
"""
Run IQ-TREE2 on an aligned fasta to infer a maximum-likelihood tree.

This script checks for the IQ-TREE executable (iqtree2 or iqtree),
validates input/output paths, and prints clear install instructions
if IQ-TREE is not found.
"""
import os
import shutil
import subprocess
...
# Paths (use absolute paths in this project)
...
def main():
    if not ensure_paths():
        print("Please generate the aligned fasta first (see 08-3_alignement.py).")
        sys.exit(1)
